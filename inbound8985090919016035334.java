...
public class candymachine {
  ...
  public static double displayMenu(){
    ...
    System.out.println("A.   15.00    Nimble");
    System.out.println("B.   20.00   curlytops");
    System.out.println("C.   15.00    Cloud9");
    ...
    if (choice.equals("A")){
      System.out.println("You have selected Nimble");
      System.out.print("Price: ");
      price = 15.00;
      return price;
    }
    else if (choice.equals("B")){
      System.out.println("You have selected Curlytops");
      System.out.print("Price: ");
      price = 20.00;
      return price;
    }
